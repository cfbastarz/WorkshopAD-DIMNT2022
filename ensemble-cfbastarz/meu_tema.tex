...
%%\titlegraphic{\includegraphics[scale=0.15]{60Anosfinal.png}\vspace*{-75pt}}
%\titlegraphic{%
%	\begin{tikzpicture}[remember picture,overlay]
%    	\node[xshift=8.3cm,yshift=0cm] at (current page.north west) {\includegraphics[scale=0.10]{60Anosfinal.png}};
%	\end{tikzpicture}
%}

% Selo de 60 anos do INPE (comentar a linha abaixo caso não queira utilizar)
%\titlegraphic{\includegraphics[scale=0.15]{60Anosfinal.png}\vspace*{-50pt}}
\titlegraphic{\includegraphics[scale=0.25]{logo_monan_pequeno.png}\vspace*{-50pt}}
